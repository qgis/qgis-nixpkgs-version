...
# flake.nix
{
  ...
  outputs = { self, nixpkgs-26-05, nixpkgs-unstable }: {
...
- **`nixpkgs-26-05`** – Stable NixOS 26.05 release
...
- **Updates**: Both `nixpkgs-26-05` and `nixpkgs-unstable` (via matrix strategy)
- **Process**:
